...
from local_llm import predict_one_local
from prompts import (
...
ZS_NAIVE_PROMPT_STR = {
    ...
    "qwen": ZS_NAIVE_PROMPT_STR_FOR_CLAUDE,
    "llama": ZS_NAIVE_PROMPT_STR_FOR_CLAUDE
}
...
ZS_KEYWORD_PROMPT_STR = {
    ...
    "qwen": ZS_KEYWORD_PROMPT_STR_FOR_CLAUDE,
    "llama": ZS_KEYWORD_PROMPT_STR_FOR_CLAUDE
}

ZS_COT_PROMPT_STR = {
    "local_mistral": ZS_COT_PROMPT,
    "qwen": ZS_COT_PROMPT,
    "llama": ZS_COT_PROMPT
}
...
def run_inference(model_name, kw_strategy, kw_model_top_k, dataset, dataset_dir, output_dir, inference_on_split="test"):
    ...
    # NO multiprocessing with GPU
      all_res = [predict_one_local(ex, model_name) for ex in tqdm.tqdm(inference_data)]
    else:
      with Pool(4) as p:
